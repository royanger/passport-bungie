...
const BUNGIE_CLIENT_ID = '--insert-bungie-client-id-here--';
const BUNGIE_CLIENT_SECRET = '--insert-bungie-client-secret-here--';
const BUNGIE_APIKEY = '--insert-bungie-api-key-here--';
const CALLBACK_URI = '--insert-callback-uri-here--';
